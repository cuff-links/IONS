...
CREATE TABLE [dbo].[CLIENT](
	[Client#] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	...
	[Referral#] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Email] [varchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[SalesID] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
 CONSTRAINT [pk_Client#] PRIMARY KEY CLUSTERED 
(
	[Client#] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON),
 CONSTRAINT [uk_SSN_Customer] UNIQUE NONCLUSTERED 
(
	[SSN] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
...
CREATE TABLE [dbo].[PRODUCT](
	...
	[RelatedTelephone#] [varchar](15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Price] [numeric](8, 2) NOT NULL,
	[Technology] [varchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[Category] [varchar](25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	[PerMinute] [numeric](4, 2) NULL,
...
CREATE TABLE [dbo].[ORDERS](
	[Order#] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
 ...
 CONSTRAINT [pk_Order#_Orders] PRIMARY KEY CLUSTERED 
(
	[Order#] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
)
...
CREATE TABLE [dbo].[INVOICE](
	[InvoiceID] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[CLIENTSPRODUCT](
	[Client#] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[ProductID] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL
)
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_DupIndex_ProductID] ON [dbo].[CLIENTSPRODUCT] 
(
	[ProductID] ASC,
	[Client#] ASC
...
CREATE UNIQUE NONCLUSTERED INDEX [IX_DupIndex_ProductID] ON [dbo].[ORDEREDPRODUCT] 
(
	[ProductID] ASC,
	[Order#] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = ON, DROP_EXISTING = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
...
CREATE TABLE [dbo].[INVOICEDPRODUCT](
	[InvoiceID] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	[ProductID] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
 CONSTRAINT [pk_InvoiceID_productID_InvoicedProduct] PRIMARY KEY CLUSTERED 
(
	[InvoiceID] ASC,
	[ProductID] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON)
...
--If referral number does not exist in client table, change to null and change referralBit to false or 0.
IF (NOT EXISTS (SELECT TOP 1 * FROM CLIENT WHERE Client# = @Referral#))
BEGIN
	SET @Referral# = NULL
	SET @ReferralBit = 0
END
...
BEGIN TRANSACTION
--Declare Order# and set to a random number
Declare @OrderNumber VARCHAR(10)
SET @OrderNumber = 'C' + (CAST(CAST( RAND() * 1000000000 as BIGINT) as VARCHAR))



--Check if Order# exists in the Employee Table. If so, set to new random number.
WHILE( EXISTS(SELECT TOP 1 * from dbo.ORDERS WHERE Order# = @OrderNumber))
	BEGIN
		SET @OrderNumber = 'C' + (CAST(CAST( RAND() * 1000000000 as BIGINT) as VARCHAR))	
	END
...
INSERT INTO dbo.ORDERS
         VALUES
(@OrderNumber,'P',@DueDate, @ClientNumber, @Comments, @EmployeeID)
...
IF @Product1 IS NOT NULL
	BEGIN 
		INSERT INTO dbo.ORDEREDPRODUCT VALUES  ( @OrderNumber, @Product1 )
	END
...
IF @Product2 IS NOT NULL
	BEGIN 
		INSERT INTO dbo.ORDEREDPRODUCT VALUES  ( @OrderNumber, @Product2 )
	END
...
IF @Product3 IS NOT NULL
	BEGIN 
		INSERT INTO dbo.ORDEREDPRODUCT VALUES  ( @OrderNumber, @Product3 )
	END
...
IF @Product4 IS NOT NULL
	BEGIN 
		INSERT INTO dbo.ORDEREDPRODUCT VALUES  ( @OrderNumber, @Product4 )
	END
...
IF @Product5 IS NOT NULL
	BEGIN 
		INSERT INTO dbo.ORDEREDPRODUCT VALUES  ( @OrderNumber, @Product5 )
	END
...
GO
ALTER TABLE [dbo].[ORDERS]  WITH CHECK ADD  CONSTRAINT [fk_Client#_Orders] FOREIGN KEY([Client#])
REFERENCES [dbo].[CLIENT] ([Client#])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ORDERS] CHECK CONSTRAINT [fk_Client#_Orders]
GO
...
GO
ALTER TABLE [dbo].[INVOICE]  WITH NOCHECK ADD  CONSTRAINT [fk_customer#_Invoice] FOREIGN KEY([Client#])
REFERENCES [dbo].[CLIENT] ([Client#])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[INVOICE] CHECK CONSTRAINT [fk_customer#_Invoice]
GO
ALTER TABLE [dbo].[CLIENTSPRODUCT]  WITH CHECK ADD  CONSTRAINT [fk_Client#_ClientsProduct] FOREIGN KEY([Client#])
REFERENCES [dbo].[CLIENT] ([Client#])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CLIENTSPRODUCT] CHECK CONSTRAINT [fk_Client#_ClientsProduct]
GO
ALTER TABLE [dbo].[CLIENTSPRODUCT]  WITH CHECK ADD  CONSTRAINT [fk_ProductID_ClientsProduct] FOREIGN KEY([ProductID])
REFERENCES [dbo].[PRODUCT] ([ProductID])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CLIENTSPRODUCT] CHECK CONSTRAINT [fk_ProductID_ClientsProduct]
GO
...
REFERENCES [dbo].[aspnet_Users] ([UserId])
GO
ALTER TABLE [dbo].[ORDEREDPRODUCT]  WITH CHECK ADD  CONSTRAINT [fk_Order#_OrderedProduct] FOREIGN KEY([Order#])
REFERENCES [dbo].[ORDERS] ([Order#])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ORDEREDPRODUCT] CHECK CONSTRAINT [fk_Order#_OrderedProduct]
GO
ALTER TABLE [dbo].[ORDEREDPRODUCT]  WITH CHECK ADD  CONSTRAINT [fk_ProductID_OrderedProduct] FOREIGN KEY([ProductID])
REFERENCES [dbo].[PRODUCT] ([ProductID])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ORDEREDPRODUCT] CHECK CONSTRAINT [fk_ProductID_OrderedProduct]
GO
ALTER TABLE [dbo].[INVOICEDPRODUCT]  WITH CHECK ADD  CONSTRAINT [fk_InvoiceID_InvoicedProduct] FOREIGN KEY([InvoiceID])
REFERENCES [dbo].[INVOICE] ([InvoiceID])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[INVOICEDPRODUCT] CHECK CONSTRAINT [fk_InvoiceID_InvoicedProduct]
GO
ALTER TABLE [dbo].[INVOICEDPRODUCT]  WITH CHECK ADD  CONSTRAINT [fk_ProductID_InvoicedProduct] FOREIGN KEY([ProductID])
REFERENCES [dbo].[PRODUCT] ([ProductID])
ON UPDATE CASCADE
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[INVOICEDPRODUCT] CHECK CONSTRAINT [fk_ProductID_InvoicedProduct]
GO
